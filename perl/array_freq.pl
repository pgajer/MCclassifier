...
=head1 DESCRIPTION
  ...
  This script generates a table of label frequencies from a one column table.

=head1 SYNOPSIS

  array_freq.pl -i <taxon file> -o <freq file> [Options]
...
=head1 EXAMPLE
  ...
  array_freq.pl --print -i cxhb_FL_QCed_trAlgn_condensed_phylum.leaves -o cxhb_FL_QCed_trAlgn_condensed_phylum.freq
