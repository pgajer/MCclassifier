...
print ROUT "itr\ttestSize\tnKnownSpp\tnNovelSpp\tpTPknownSpp\tnTPknownSpp\tnIDsKnownSpp\tpFPnovelSpp\tnFPnovelSpp\tnIDsNovelSpp\n";
...
foreach my $i (0..($nFolds-1))
{
  ...
  print ROUT "$i\t$nTestIDs\t$nKnownSpp\t$nNovelSpp\t". sprintf("%.2f", $pCorrectClKnownSpp[$i]) . "\t$nCorrectClKnownSpp\t$nTestIDsKnownSpp\t";
...
print "\tReport writtent to $cvReportFile\n\n";
